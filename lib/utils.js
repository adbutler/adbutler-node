...
function getQueryParamsAndCallback(idOrQueryParams, queryParamsOrCB, callback) {
    return {
        ...
        queryParams: idOrQueryParams !== null && typeof idOrQueryParams === 'object' ? idOrQueryParams : (queryParamsOrCB !== null && typeof queryParamsOrCB === 'object' ? queryParamsOrCB : null),
